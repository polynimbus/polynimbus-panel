...
<ul>
	...
	<li><a href="storage.php">AWS/Azure/Backblaze/Google/Linode - list of cloud storage buckets/shares/blobs/etc.</a></li>
	<li><a href="zones.php">AWS/Azure/Cloudflare/GoDaddy/Linode - list of DNS hosted zones (domains)</a></li>
	...
	<li><a href="linode-users.php">Linode Cloud - list of users and permissions</a></li>
</ul>
<br />
<?php
